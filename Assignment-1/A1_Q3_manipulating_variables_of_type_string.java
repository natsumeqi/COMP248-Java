...
// 28/09/2017
//
// This program analyzes the words that users input and creat new words
// ----------------------------------------------------------------------

import java.util.Scanner;  

public class A1_Q3_manipulating_variables_of_type_string {

	public static void main(String[] args) 
	{
		// display a welcome message on the screen
		System.out.println("------------------------------");
		System.out.println("    Yanqi's Text Analyzer ");
		System.out.println("------------------------------\n");
		...
		System.out.println("Thank you for using Yanqi's Text Analyzer!");
